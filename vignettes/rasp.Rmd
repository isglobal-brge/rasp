...
```{r plotTernaryGender, fig.cap="Ternary plot. Ternary plot corresponding to the splicing ratios of three transcripts (1st, 2nd and 3rd) belonging to gene SRY in males and females."}
