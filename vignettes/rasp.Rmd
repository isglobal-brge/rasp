...
We can also compare the splicing ratios for a group of individuals using the `group` argument. For instance, let us compare splicing patterns of males and females for the gene SRY (ENSG00000184895)
...
plotTernary(YRI, "ENSG00000184895", group = genderYRI, transcripts=1:3)
```
