...
This type of data is also known as compositional data and can be represented in the simplex using the function `plotTernary()` as illustrate Figure \ref{fig_simplex} that can be obtained by typing
